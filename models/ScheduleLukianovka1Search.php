...
/**
 * ScheduleLukianovka1Search represents the model behind the search form about `app\models\ScheduleLukianovka1`.
 */
class ScheduleLukianovka1Search extends ScheduleLukianovka1
{
    /**
     * @inheritdoc
     */
    ...
    {
        $query = ScheduleLukianovka1::find();
