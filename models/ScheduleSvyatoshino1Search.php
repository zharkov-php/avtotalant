...
/**
 * ScheduleSvyatoshino1Search represents the model behind the search form about `app\models\ScheduleSvyatoshino1`.
 */
class ScheduleSvyatoshino1Search extends ScheduleSvyatoshino1
{
    /**
     * @inheritdoc
     */
    ...
    {
        $query = ScheduleSvyatoshino1::find();
