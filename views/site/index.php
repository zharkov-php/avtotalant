<div class="about" id="about">
    <div class="container">
        <div class="col-md-6 col-sm-6 about-left">
            ...
            <p>
                Автошкола Талант –находиться в Шевченковском, Днепровском и Святошинском районе.
                Автошкола проводит подготовку...</p>
            <p class="w3l"></p>
...
<!---->
                        ...
                        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2540.1367050224267!2d30.39312248760521!3d50.4571789840994!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x40d4cc5e3b90de27%3A0x57d0f2004b628dce!2z0LLRg9C70LjRhtGPINCn0LjRgdGC0Y_QutGW0LLRgdGM0LrQsCwgMg!5e0!3m2!1suk!2sua!4v1484989663411" width="250" height="250" frameborder="0" style="border:0" allowfullscreen></iframe>
            ...
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="panel panel-default">
                            <!-- Default panel contents -->
                            <div class="panel-heading">Расписание  групп на м.Левобережная :</div>
            ...
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="panel panel-default">
                            <!-- Default panel contents -->
                            <div class="panel-heading">Расписание  групп на м.Лукьяновка :</div>
                            ...
                            <table class="table table-striped">
                                ...
                                <?php foreach($lukianovka as $luk): ?>
                                    <tr class="<?php echo $luk['status_color_Lesson'] ; ?>">

                                        <td><?php echo $luk['name_Lesson'] ; ?></td>
                                        <td><?php echo $luk['time_Lesson'] ; ?></td>
                                        <td><?php echo $luk['date_Lesson'] ; ?></td>
                                        <td><font color="red"><?php echo $luk['sale_Lesson'] ; ?></font></td>
                                    </tr>
